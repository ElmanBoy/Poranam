        ...
        <tr id="tr<?= $row_catalog['id'] ?>">
                ...
                <td>
                    <div class="custom_checkbox">
                        <label class="container">
                            <input type="checkbox" class="group_check" value="<?= $row_catalog['id'] ?>"><span
            ...
            <td>
                ...
                if (intval($_SESSION['user_level']) > 0 && intval($_SESSION['user_level']) != 10) {
                    ...
                    <a href="" class="user_profile_link"
                       data-user_id="<?= $row_catalog['field4'] ?>"><?= $row_catalog['field4'] ?></a>
                    <?
                } else {
                ...
                switch (intval($row_catalog['field14'])) {
                    ...
                    case 11:
                        ...
                        if ($_SESSION['user_level'] == 4) {
                            ...
                            <button class="button icon red init_remove" data-id="<?= $row_catalog['id'] ?>"
                                    title="Удалить">
            ...
            <td>
                <button class="button icon text meeting_list" data-id="<?= $row_catalog['id'] ?>">
                    <span class="material-icons">list</span>Список
                </button>
            </td>
        </tr>
        <tr class="hidden">
