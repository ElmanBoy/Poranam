...
function getInitStatus(int $status){
    $res = null;
    $status = intval($status);
    $res = el_dbselect("SELECT COUNT(id) AS count FROM catalog_init_data WHERE field14 = $status",
        0, $res, 'row', true);
    return number_format(intval($res['count']), 0, '', ' ');
}

$initStatus1 = getInitStatus(1);
$initStatus2 = getInitStatus(2);
$initStatus3 = getInitStatus(3);
$initStatus4 = getInitStatus(4);
$initStatus5 = getInitStatus(5);
$initStatus6 = getInitStatus(6);
$initStatus7 = getInitStatus(7);
$initStatus10 = getInitStatus(10);
$initStatus13 = getInitStatus(13);
$initStatus14 = getInitStatus(14);
$initStatus15 = getInitStatus(15);
