			...
			<main>
				...
				<div class="box">
					<div class="control">
                        ...
                        ?>
						<button class="text icon<?=($filtered > 0) ? ' marked' : ''?>" id="button_votes_filter"><span
				...
				<div class="box">
					<div class="scroll_wrap" id="init_table">
						...
						if (intval($_SESSION['user_level']) == 4) {
                            ...
                            /*if(!isset($_GET['sf5']))$_GET['sf5'] = ['0', '', 'null', $_SESSION['user_subject']];
                            if(!isset($_GET['sf6']))$_GET['sf6'] = ['0', '', 'null', $_SESSION['user_region']];
							if(!isset($_GET['sf7']))$_GET['sf7'] = ['0', '', 'null', $_SESSION['user_prof']];
                            if(!isset($_GET['sf8']))$_GET['sf8'] = ['0', '', 'null', $_SESSION['user_city']];
                            if(!isset($_GET['sf9']))$_GET['sf9'] = ['0', '', 'null', $_SESSION['user_index']];
                            if(!isset($_GET['sf10']))$_GET['sf10'] = ['0', '', 'null', $_SESSION['user_street']];
                            if(!isset($_GET['sf11']))$_GET['sf11'] = ['0', '', 'null', $_SESSION['user_house']];*/
                            if(!isset($_GET['sf14_from']))$_GET['sf14_from'] = 14; //мероприятие запущено
                            $_GET['sort'] = 'sf2';
						}
