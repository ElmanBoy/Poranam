...
<div class="content">
            ...
            <div class="box">
                <div class="control">
                    ...
                    if ($_SESSION['user_level'] > 0) {
                        ?>
                        <button class="text icon" id="button_initiative_new"><span
                                    class="material-icons">add_circle</span>Создать
                        </button>
                        <?
                        if ($_SESSION['user_level'] == 11) {
                            ?>
                            <button class="text icon group_action" id="button_initiative_start" disabled><span
                                        class="material-icons">play_arrow</span>Запустить
                            </button>
                            <button class="text icon group_action" id="button_initiative_stop" disabled>
                                <span class="material-icons">stop</span>Завершить
                            </button>

                            <button class="text icon group_action" id="button_initiative_remove" disabled>
    ...
    <script src="/js/initiatives.js?ver=<?=el_genpass()?>"></script>
<?php
