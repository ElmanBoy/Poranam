...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #e4e2e2">
...
<table class="nl-container"
	   style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #e4e2e2;width: 100%"
	...
	<tr style="vertical-align: top">
		<td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="center" style="background-color: #e4e2e2;"><![endif]-->
								...
								<div
									...
									<div align="center" class="img-container center  autowidth  fullwidth"
										...
										<img class="center  autowidth  fullwidth" align="center" border="0"
											 src="http://nur24.ru/images/letter/rounder-up.png" alt="Image"
											 title="Image"
								...
								<div
									...
									<div align="center" class="img-container center  autowidth "
										...
										<img class="center  autowidth " align="center" border="0"
											 src="http://nur24.ru/img/logo.png" alt="Image" title="Image"
											 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 351px"
											 width="351">
										<!--[if mso]></td></tr></table><![endif]-->
									</div>
						...
						<div class="col num12"
							...
							<div style="background-color: transparent; width: 100% !important;">
								...
								<div
									...
									<![endif]-->
									<div
										style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%;color:#0D0D0D; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
										<div
											...
											<p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
												<span style="font-size: 28px; line-height: 33px;"><strong><span
															style="line-height: 33px; font-size: 28px;"><?= $caption ?></span>
											</p></div>
									</div>
									<!--[if mso]></td></tr></table><![endif]-->
									...
									<div align="center" class="img-container center  autowidth "
										...
										<![endif]-->
										<img class="center  autowidth " align="center" border="0"
											 src="http://nur24.ru/images/letter/divider.png" alt="Image" title="Image"
									...
									<![endif]-->
									<div
										style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#555555; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
										...
										<![endif]-->
										<div
											style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#0D0D0D; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
											<div
												...
												<p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><?= $text ?></p>
											</div>
										</div>
										<!--[if mso]></td></tr></table><![endif]-->


										<? if (isset($buttonText) && strlen($buttonText) > 0) { ?>
													...
													<tr>
														<td style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;"
															...
															<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
																		 ...
																		 href=""
																		 style="height:46pt; v-text-anchor:middle; width:172pt;"
																		 arcsize="7%" strokecolor="#F24141"
																		 fillcolor="#F24141">
																<w:anchorlock/>
																<v:textbox inset="0,0,0,0">
																	<center
																		style="color:#ffffff; font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size:16px;">
												<![endif]-->
												<div style="color: #ffffff; background-color: #F24141; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 300px; width: 200px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none;">
													<a href="<?= $buttonUrl ?>"
													   style="color: #fff;text-decoration: none;display: block;padding-top: 15px;padding-right: 15px;padding-bottom: 15px;padding-left: 15px;">
														<span style="font-size:16px;line-height:32px;"><?= $buttonText ?></span>
													</a>
												</div>
											...
											<div style="display: table; max-width:131px;">
												...
												<table align="left" border="0" cellspacing="0" cellpadding="0"
													...
													<tr style="vertical-align: top">
														<td align="left" valign="middle"
															...
															<a href="https://vk.com/trcsigma" title="Vkontakte"
															   target="_blank">
																<img
																	src="http://nur24.ru/images/letter/vkontakte@2x.png"
																	alt="Vkontakte" title="Vkontakte" width="32"
												...
												<table align="left" border="0" cellspacing="0" cellpadding="0"
													...
													<tr style="vertical-align: top">
														<td align="left" valign="middle"
															style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
															<a href="https://www.youtube.com/channel/UCQFUml7GwpHbCRf4CO_bCrw"
															   title="YouTube" target="_blank">
																<img src="http://nur24.ru/images/letter/youtube@2x.png"
												...
												<table align="left" border="0" cellspacing="0" cellpadding="0"
													...
													<tr style="vertical-align: top">
														<td align="left" valign="middle"
															style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
															<a href="https://www.instagram.com/trk.sigma/"
															   title="Instagram" target="_blank">
																<img
																	src="http://nur24.ru/images/letter/instagram@2x.png"
							...
							<div class="col num4"
								...
								<div style="background-color: transparent; width: 100% !important;">
									...
									<div
										...
										<![endif]-->
										<div
											style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%;color:#a8bf6f; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;">
											<div
												...
												<p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
													<span
														style="color: rgb(255, 255, 255); font-size: 12px; line-height: 14px;"><span
															style="font-size: 12px; line-height: 14px; color: rgb(168, 191, 111);">Tel.:</span> +7(3494)926-009<br>&#160; &#160; &#160; &#160;+7(3494)926-022</span><br>
												</p></div>
										</div>
										<!--[if mso]></td></tr></table><![endif]-->
									...
									<div
										...
										<div
											...
											<div
												style="font-size:12px;line-height:14px;color:#a8bf6f;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
												<p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
													Email <font color="#ffffff">news@nur24.ru</font></p></div>
										</div>
										<!--[if mso]></td></tr></table><![endif]-->
								...
								<div style="background-color: transparent; width: 100% !important;">
									...
									<div
										...
										<div align="center" class="img-container center  autowidth  fullwidth"
											...
											<![endif]-->
											<img class="center  autowidth  fullwidth" align="center" border="0"
												 src="http://nur24.ru/images/letter/rounder-dwn.png" alt="Image"
												 title="Image"
												 style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px"
												 width="600">
											<!--[if mso]></td></tr></table><![endif]-->
