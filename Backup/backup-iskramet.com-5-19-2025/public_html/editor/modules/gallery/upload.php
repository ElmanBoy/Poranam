...
$imgText='';
	...
	$err=$both=0;
	$errStr='';
	$_POST['swidth']=200;//(strlen($_POST['swidth'])>0)?intval($_POST['swidth']):$site_property['gallerySWidth'.$cat];
	$_POST['sheight']=200;//(strlen($_POST['sheight'])>0)?intval($_POST['sheight']):$site_property['gallerySHeight'.$cat];
	$_POST['bwidth']=1000;//(strlen($_POST['bwidth'])>0)?intval($_POST['bwidth']):$site_property['galleryBWidth'.$cat];
	$_POST['bheight']=850;//(strlen($_POST['bheight'])>0)?intval($_POST['bheight']):$site_property['galleryBHeight'.$cat];
	...
	if($err==0){ 
  		$imgText=addslashes(nl2br($_POST['text']));
	...
	$new_img = imagecreatetruecolor($_POST['swidth'], $_POST['sheight']);
