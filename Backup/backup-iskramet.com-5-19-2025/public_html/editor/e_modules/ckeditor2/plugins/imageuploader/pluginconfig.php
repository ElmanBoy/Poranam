...
$show_settings = ($_SESSION['user_level'] <= 1);

// username and password
$username = "flobus@mail.ru";
$password = md5(@filter_input("El1675894", 'password', FILTER_SANITIZE_STRING));

if(!is_dir($_SERVER['DOCUMENT_ROOT'].'/images/upload/'.$_SESSION['site_id'])){
    mkdir($_SERVER['DOCUMENT_ROOT'].'/images/upload/'.$_SESSION['site_id'], 0777);
}
...
$useruploadroot = "http://$_SERVER[HTTP_HOST]/images/";
...
$useruploadfolder = "$useruploadroot/uploads/".$_SESSION['site_id'];
$useruploadpath = $usersiteroot."$useruploadfolder/";
$foldershistory[] = $useruploadfolder;


    $useruploadfolder = "$useruploadroot/upload/".$_SESSION['site_id'];
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "images/upload/".$_SESSION['site_id'];
        

    $useruploadfolder = "images/upload/".$_SESSION['site_id'];
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "images/upload/".$_SESSION['site_id'];
