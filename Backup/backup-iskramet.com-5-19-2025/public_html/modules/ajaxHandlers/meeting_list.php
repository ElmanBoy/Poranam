...
$sql_details = array(
    'user' => $username_dbconn,
    'pass' => $password_dbconn,
    'db'   => $database_dbconn,
    'host' => $hostname_dbconn,
...
require( $_SERVER['DOCUMENT_ROOT'].'/Connections/ssp.class.php' );
