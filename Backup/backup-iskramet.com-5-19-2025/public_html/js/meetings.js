let meetings = {
    buttons_init: function(){
        ...
        $("#button_votes_approve").off("click").on("click", function(e){
            e.preventDefault();
            meetings.groupSetInitStatus(13);
        });
        ...
        $(".edit_init").off("click").on("click", function(){
            el_app.dialog_open('events_edit', $(this).data("id"));
        });

        $(".votes_approve").off("click").on("click", function(){
            meetings.setInitStatus($(this).data("id"), 13);
        });
        ...
        $(".meeting_list").off("click").on("click", function(){
            el_app.dialog_open('meeting_list', $(this).data("id"));
        });
        ...
        $(".user_profile_link").off("click").on("click", function(e){
            e.preventDefault();
            el_app.dialog_open('user_new', $(this).data("user_id"));
        });
    ...
    popupNewInit: function(){
        ...
        setTimeout(function(){$(".correspondence").scrollTop(99999);}, 500);
