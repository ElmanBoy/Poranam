            ...
            <div class="group">
                ...
                <div class="item">
                    <select data-label="Статус голосования" data-place="Выберите" name="sf14">
                        ...
                        <option value="3"<?=(intval($_GET['sf14']) == 3) ? ' selected' : ''?>>Голосование завершено</option>
                        <option value="2"<?=(intval($_GET['sf14']) == 2) ? ' selected' : ''?>>Голосование идёт</option>
