                        ...
                        <div class="group">
                            ...
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <a href="/lichnyy-kabinet/polzovateli/?sf24=%27%27"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <?/*div class="static_data">
                        ...
                        <div class="group">
                            ...
                            <div class="item">
                                <div class="el_data">
                                    <label>Всего</label>
                                    <input disabled class="el_input" type="text" value="<?=($initStatus2 + $initStatus3 +$initStatus4 + $initStatus5)?>>">
                                </div>
                            </div>
                            <div class="item">
                                <div class="el_data">
                                    <label>Одобрено</label>
                                    <input disabled class="el_input" type="text" value="<?=$initStatus2?>">
                                    <a href="/initsiativy/?sf14=2"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            <?
                            ...
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus5?>">
                                    <a href="/initsiativy/?sf14=5"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            <?
                            ...
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus3?>">
                                    <a href="/initsiativy/?sf14=3"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus4?>">
                                    <a href="/initsiativy/?sf14=4"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                    ...
                    <div class="static_data">
                        ...
                        <div class="group">
                            ...
                            <div class="item">
                                <div class="el_data">
                                    <label>Всего</label>
                                    <input disabled class="el_input" type="text" value="<?=($initStatus1 + $initStatus5 + $initStatus6 + $initStatus7)?>">
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus1?>">
                                    <a href="/golosovanie/?sf14=1"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="el_data">
                                    <label>Идёт</label>
                                    <input disabled class="el_input" type="text" value="<?=$initStatus6?>">
                                    <a href="/golosovanie/?sf14=6"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="el_data">
                                    <label>Завершено</label>
                                    <input disabled class="el_input" type="text" value="<?=$initStatus7?>">
                                    <a href="/golosovanie/?sf14=7"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus5?>">
                                    <a href="/golosovanie/?sf14=5"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                    ...
                    <div class="static_data">
                        ...
                        <div class="group">
                            ...
                            <div class="item">
                                <div class="el_data">
                                    <label>Всего</label>
                                    <input disabled class="el_input" type="text" value="<?=($initStatus10 + $initStatus13 + $initStatus15)?>">
                                </div>
                            </div>
                            <div class="item">
                                <div class="el_data">
                                    <label>Проведено</label>
                                    <input disabled class="el_input" type="text" value="<?=$initStatus15?>">
                                    <a href="/meropriyatiya/?sf14=15"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus10?>">
                                    <a href="/meropriyatiya/?sf14=10"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="el_data">
                                    ...
                                    <input disabled class="el_input" type="text" value="<?=$initStatus13?>">
                                    <a href="/meropriyatiya/?sf14=13"><button class="button icon">
                                            <span class="material-icons">visibility</span></button></a>
                                </div>
                            </div>
                        </div>
