...
if (el_checkAjax()) {
    ...
    if (isset($_POST["ajax"]) && $_POST["ajax"] == "1") {
        ...
        if ($err == 0) {
            ...
            $insertSQL = sprintf("INSERT INTO catalog_users_data (field1, field2, field3, field4, field5, field6, 
        field7, field8, field9, field10, field11, field12, field13, field14, field15, field16, field17, active, cat, site_id) 
