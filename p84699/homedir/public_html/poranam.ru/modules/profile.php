...
$curator = el_dbselect("SELECT field11 FROM catalog_users_data WHERE id = ".intval($us['field16']),
  0, $curator, 'row', true);

if(strlen(trim($us['field23'])) > 0){
    $sin = 'https://poranam.ru/?invite='.$us['field23'];
}else{
    $sin = 'https://poranam.ru/?invite='.el_genSinonim($_SESSION['user_id']);
}
?>
<main>
    <div class="box">
        <h1>Настройки ID <?=$us['field11'].'-'.$us['id']?></h1>
    </div>
    <div class="box">
                ...
                <div class="group">
                    ...
                    <div class="item">
                        <div class="el_data input_number">
                            ...
                            <input disabled class="el_input"
                                   value="<?=(intval($us['field16']) > 0) ? $curator['field11'].'-'.$us['field16'] : 'не указан'?>"
                                   type="text">
                        </div>
                    </div>
