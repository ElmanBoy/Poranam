...
$desc = el_dbselect($query_desc, 0, $desc, 'result', true);
$row_desc = el_dbfetch($desc);
?>
<html>
<head>
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0">
    <form action="<?php echo $editFormAction; ?>" name="edit" method="POST">
        ...
        <tr>
            ...
            <td width="90%"><textarea name="ptext" cols="50" rows="10"
                                      id="ptext"><?php echo $row_desc['ptext']; ?></textarea><br>
                <input name="Button" type="button"
                       onClick="MM_openBrWindow('/editor/newseditor.php?field=ptext&form=edit','editor','','595','500','true')"
                       value="HTML-редактор" class="but"></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <br>
                <input type="submit" name="Submit" value="Сохранить" class="but agree"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="button" name="Submit2" value="Закрыть" onClick="top.closeDialog()" class="but close"></td>
        </tr>
