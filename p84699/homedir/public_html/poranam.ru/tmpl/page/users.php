                ...
                <div class="control">
                    ...
                    if ($_SESSION['user_level'] > 0) {
                        ...
                        if ($_SESSION['user_level'] == 11) {
							...
							<button class="text icon" onclick="pop_up_warning(); return false"><span class="material-icons">lock</span>Заблокировать</button>
							<button class="text icon red" onclick="pop_up_warning(); return false"><span class="material-icons">delete_forever</span>Удалить</button>
