 ...
 */
$log_dir=$_SERVER['DOCUMENT_ROOT'].'/editor/e_modules/logging/';
include($log_dir.'database.php');
include($log_dir.'getip.php');
include($log_dir.'log.class.php');
$log = new Logs;
...
class Session
{
   ...
   function startSession(){
	  ...
	  $this->logged_in = 'yes';
	  $_SESSION['username'] = $this->username = $_SESSION['login'];
