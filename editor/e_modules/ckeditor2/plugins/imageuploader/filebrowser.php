...
if(isset($_GET['path'])) {
    ...
    <div class="folderInfo">
        <span><?= $imagebrowser5 ?>: </span><?= (strlen($_GET['path']) > 0) ? str_replace($_SERVER['DOCUMENT_ROOT'], '', $_GET['path']) : $useruploadfolder ?>
    </div>
    <div id="files">
        <?php
        loadImages($_GET['path']);
        ?>
    </div>
    ...
    <div id="imageFullSreen" class="lightbox popout">
        <div class="buttonBar">
            <button id="imageFullSreenClose" class="headerBtn" onclick="$('#imageFullSreen').hide(); $('#background').slideUp(250, 'swing');"><img
            ...
            <button class="headerBtn greenBtn" id="imgActionUse" onclick="#" class="imgActionP"><img src="img/cd-icon-use.png"
                                                                                                     class="headerIcon"> <?php echo $buttons3; ?></button>
        </div>
        <br><br>
        <img id="imageFSimg" class="preview" src="#" style="display: block;"><br>
        <video controls="controls" class="preview" id="imageFSvideo" src="#" style="display: none">&nbsp;</video>
    </div>

    <div id="uploadImgDiv" class="lightbox popout">
        <div class="buttonBar">
            <button class="headerBtn" onclick="$('#uploadImgDiv').hide(); $('#background2').slideUp(250, 'swing');"><img src="img/cd-icon-close.png"
                                                                                                                         class="headerIcon"></button>
            <button class="headerBtn greenBtn" name="submit" onclick="$('#uploadImgForm').submit();"><img src="img/cd-icon-upload.png"
                                                                                                          class="headerIcon"> <?php echo $buttons7; ?></button>
        </div>
        <br><br><br>
        <form action="imgupload.php" method="post" enctype="multipart/form-data" id="uploadImgForm" onsubmit="return checkUpload();">
            ...
            <h3 class="settingsh3" style="font-size:12px;font-weight:lighter;"><?php echo $uploadpanel2; ?><br><span
                        style="font-weight:bolder;">"<?php echo $useruploadfolder; ?>"</span> (<?php echo $uploadpanel3; ?>)</h3>
            <br>
        </form>
    </div>
    ...
    <?php if ($show_settings) { ?>
        <div id="settingsDiv" class="lightbox popout">
            <div class="buttonBar">
                <button class="headerBtn" onclick="$('#settingsDiv').hide(); $('#background3').slideUp(250, 'swing');"><img src="img/cd-icon-close.png"
                                                                                                                            class="headerIcon"></button>
            </div>
            <br><br><br>
        ...
        <?php } */ ?>
            ...
            <!--FAQ button-->
            <p class="uploadP" onclick="window.open('http://imageuploaderforckeditor.altervista.org/support/','_blank');"><img src="img/cd-icon-faq.png"
                                                                                                                               class="headerIcon"> <?php echo $panelsettings13; ?>
            </p>
            <!--report a bug-->
            <p class="uploadP"
            ...
            <p class="uploadP" onclick="window.open('https://icons8.com','_blank');"><img src="img/cd-icon-images.png"
                                                                                          class="headerIcon"> <?php echo $panelsettings19; ?></p>
    ...
    <noscript>
        <div class="noscript">
            <div id="folderError" class="noscriptContainer popout"><b><?php echo $alerts1; ?></b><br><br><?php echo $alerts5; ?> <a
                        href="http://www.enable-javascript.com/" target="_blank"><?php echo $alerts6; ?></a><br><br><?php echo $alerts4; ?> </div>
        </div>
    </noscript>

    <?php
}else{
    echo 'Выберите путь слева';
}
