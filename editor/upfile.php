...
<table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0">
  ...
  <?php if($mode=='files'){ ?>
    ...
    <td width="15%" height="21" valign="bottom">   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="stab">
      <tr>
         <td><img src="/editor/img/tab_lside_inactive.gif" width="3" height="19"></td><td width="100%" align="center" onMouseOver="MM_displayStatusMsg('Перейти к файлам');return document.MM_returnValue" onMouseOut="MM_displayStatusMsg('');return document.MM_returnValue"><a href="upfile.php?mode=images&pdir=<?=$_SERVER['DOCUMENT_ROOT']?>/images">Изображения</a></td>
         <td><img src="/editor/img/tab_rside_inactive.gif" width="3" height="19"></td>
      </tr>
    </table>
<?php } else{ ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="stab">
      <tr>
         <td><img src="/editor/img/tab_lside_inactive.gif" width="3" height="19"></td><td width="100%" align="center" onMouseOver="MM_displayStatusMsg('Перейти к файлам');return document.MM_returnValue" onMouseOut="MM_displayStatusMsg('');return document.MM_returnValue"><a href="upfile.php?mode=files&pdir=<?=$_SERVER['DOCUMENT_ROOT']?>/files">Файлы</a></td>
         <td><img src="/editor/img/tab_rside_inactive.gif" width="3" height="19"></td>
      </tr>
    </table>
      </td>
