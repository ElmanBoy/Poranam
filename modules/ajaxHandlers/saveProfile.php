...
if (el_checkAjax() && intval($_SESSION['user_id']) > 0) {
    ...
    if (isset($_POST["ajax"]) && $_POST["ajax"] == "1") {
        ...
        $oldData = el_dbselect("SELECT * FROM catalog_users_data WHERE id = '" . $_SESSION['user_id'] . "'",
            0, $res, 'row', true);
        ...
        field7 = %s, field8 = %s, field9 = %s, field10 = %s, field11 = %s, field12 = %s, field13 = %s, field15 = %s, field26=%s WHERE id = %s",
            ...
            $result = true;
            $message = 'Ваши данные успешно сохранены.<script>setTimeout(function(){document.location.reload()}, 2000)</script>';
        } else {
