...
if (el_checkAjax()) {
    ...
    if ($err == 0) {
        ...
        $insert = array(
            ...
            'field8' => (isset($_POST['init_select_all']) && $_POST['init_select_all'] == '1') ? '' : addslashes($_POST['city']),
            'field9' => (isset($_POST['init_select_all']) && $_POST['init_select_all'] == '1') ? '' : addslashes($_POST['post_index']),
            'field17' => (isset($_POST['init_select_all']) && $_POST['init_select_all'] == '1') ? '' : ((is_array($_POST['groups'])) ? implode(', ', $_POST['groups']) : $_POST['groups']),
            'field10' => (isset($_POST['init_select_all']) && $_POST['init_select_all'] == '1') ? '' : addslashes($_POST['street']),
            'field11' => (isset($_POST['init_select_all']) && $_POST['init_select_all'] == '1') ? '' : addslashes($_POST['house']),
