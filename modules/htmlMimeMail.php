...
class htmlMimeMail
{
    ...
    function htmlMimeMail ()
    {
        ...
        $this->smtp_params['host'] = 'smtp.mass.mail.mosreg.ru';
        $this->smtp_params['port'] = 587;
        $this->smtp_params['helo'] = $helo;
        $this->smtp_params['auth'] = true;
        $this->smtp_params['user'] = 'noreply';
        $this->smtp_params['pass'] = '2ky2QP({}8';
    ...
    function send ( $recipients, $type = 'mail' )
    {
        ...
        switch ($type) {
            ...
            case 'smtp':
                ...
                $sm = new smtp($this->smtp_params);
                $smtp = $sm->connect($this->smtp_params);
